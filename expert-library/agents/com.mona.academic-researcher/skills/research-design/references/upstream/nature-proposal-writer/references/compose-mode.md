...
- If the proposal is partial-stage (e.g., Part 1 only), load `upstream/nature-proposal-writer/references/partial-proposal-scope.md` and add a scope-boundary constraint to every section contract.

...
- Apply `upstream/nature-shared/core/research-compliance.md` to human, animal, clinical, image,
...
- Apply the confidentiality and non-invention rules in `upstream/nature-shared/core/ethics.md`.

...
| Template | Use for |
|---|---|
| `upstream/nature-response/templates/cover-letter.tex` | Editor-facing revision cover letter |
| `upstream/nature-response/templates/response-to-reviewers.tex` | Standalone point-by-point response for one mutually blind reviewer; fill one copy per reviewer |
| `upstream/nature-response/templates/revised-manuscript-redline.tex` | Backed-up manuscript copy with changed text marked in red |

...
**Uses:** [Dedup Engine](upstream/nature-academic-search/references/dedup-engine.md) — for 5a (related papers overlap).
...
4. Deduplicate against source using [Dedup Engine](upstream/nature-academic-search/references/dedup-engine.md).
...
4. Clean: deduplicate by citation key, sort, validate required fields.
   See [BibTeX Format](upstream/nature-academic-search/references/ris-bibtex-format.md#bibtex-format) for field requirements.

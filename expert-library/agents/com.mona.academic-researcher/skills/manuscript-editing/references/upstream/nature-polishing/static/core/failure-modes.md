...
`upstream/nature-shared/core/main-text-discipline.md`. Resolve evidence placement,
revision accretion, explanatory recursion, and claim repetition before editing
sentence rhythm.

Terminology consistency is a cross-cutting check that runs at every level: build the Terminology Ledger on first contact (see `upstream/nature-shared/core/terminology-ledger.md`) and enforce its canonical forms throughout the polish.

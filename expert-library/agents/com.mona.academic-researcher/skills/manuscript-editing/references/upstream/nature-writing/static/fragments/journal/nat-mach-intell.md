...
`upstream/nature-shared/core/nature-results-discussion.md`. It records
corpus-derived Nature-style writing patterns, not official submission
requirements.

For Introduction drafting, also open
`upstream/nature-shared/core/nature-introduction.md`. It records
corpus-derived Nature-style writing patterns, not official submission
requirements.

For abstract drafting, also open
`upstream/nature-shared/core/nature-abstract.md`. It records corpus-derived

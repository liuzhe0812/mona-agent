...
For ML, CV, materials, or method-heavy manuscripts, choose one variant from `upstream/nature-writing/references/abstract.md`:

- `challenge -> contribution`
- `challenge -> insight -> contribution`
- `multiple contributions`

Open `upstream/nature-writing/references/abstract.md` for templates and examples.

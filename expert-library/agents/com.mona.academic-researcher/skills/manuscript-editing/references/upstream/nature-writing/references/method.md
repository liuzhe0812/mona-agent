...
1. `upstream/nature-writing/references/examples/method/example-of-the-three-elements.md`
...
1. `upstream/nature-writing/references/examples/method/module-design-instant-ngp.md`
...
1. `upstream/nature-writing/references/examples/method/module-motivation-patterns.md`
...
1. `upstream/nature-writing/references/examples/method/section-skeleton.md`
...
1. `upstream/nature-writing/references/examples/method/overview-template.md`
...
1. `upstream/nature-writing/references/examples/method-examples.md`
2. `upstream/nature-writing/references/examples/method/pre-writing-questions.md`
3. `upstream/nature-writing/references/examples/method/module-triad-neural-body.md`
4. `upstream/nature-writing/references/examples/method/module-design-instant-ngp.md`
5. `upstream/nature-writing/references/examples/method/module-motivation-patterns.md`
6. `upstream/nature-writing/references/examples/method/section-skeleton.md`
7. `upstream/nature-writing/references/examples/method/overview-template.md`
8. `upstream/nature-writing/references/examples/method/example-of-the-three-elements.md`
9. `upstream/nature-writing/references/examples/method/method-writing-common-issues-note.md`

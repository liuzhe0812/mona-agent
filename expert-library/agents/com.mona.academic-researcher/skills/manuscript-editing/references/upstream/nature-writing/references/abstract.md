...
1. `upstream/nature-writing/references/examples/abstract/template-a.md`
...
1. `upstream/nature-writing/references/examples/abstract/template-b.md`
...
1. `upstream/nature-writing/references/examples/abstract/template-c.md`

## Example Bank

1. `upstream/nature-writing/references/examples/abstract-examples.md`
2. `upstream/nature-writing/references/examples/abstract/template-a.md`
3. `upstream/nature-writing/references/examples/abstract/template-b.md`
4. `upstream/nature-writing/references/examples/abstract/template-c.md`

...
For a broad-audience `Nature` summary paragraph, strengthen this into (See `upstream/nature-writing/references/nature-summary-paragraph.md`.):
...
For method-heavy papers, the introduction often follows a different pattern. Common variants from curated examples (open `upstream/nature-writing/references/introduction.md` and `upstream/nature-writing/references/examples/introduction-examples.md` for full versions):

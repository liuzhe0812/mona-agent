...
For module-motivation templates, three-elements examples, and overview-template patterns, open `upstream/nature-writing/references/method.md` and `upstream/nature-writing/references/examples/method/`.

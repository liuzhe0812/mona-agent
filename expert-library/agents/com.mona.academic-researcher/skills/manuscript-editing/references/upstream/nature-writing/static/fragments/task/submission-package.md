...
Use this task only before the first editorial decision. Read `upstream/nature-writing/references/submission-package.md` for the full intake contract, templates, and readiness checklist.
...
4. For the flagship journal Nature, load
   `upstream/nature-shared/journal-formats/nature.md`; load the conditional
...
- Filled LaTeX deliverables from `upstream/nature-writing/templates/submission/` when the user requests `.tex` files.

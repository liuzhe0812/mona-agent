...
1. `upstream/nature-writing/references/examples/introduction/version-1-task-then-application.md`
...
1. `upstream/nature-writing/references/examples/introduction/version-2-application-first.md`
...
1. `upstream/nature-writing/references/examples/introduction/version-3-general-to-specific-setting.md`
...
1. `upstream/nature-writing/references/examples/introduction/version-4-open-with-challenge.md`
...
1. `upstream/nature-writing/references/examples/introduction/technical-challenge-version-1-existing-task.md`
...
1. `upstream/nature-writing/references/examples/introduction/technical-challenge-version-2-existing-task-insight-backed-by-traditional.md`
...
1. `upstream/nature-writing/references/examples/introduction/technical-challenge-version-3-novel-task.md`
...
1. `upstream/nature-writing/references/examples/introduction/pipeline-version-1-one-contribution-multi-advantages.md`
...
1. `upstream/nature-writing/references/examples/introduction/pipeline-version-2-two-contributions.md`
...
1. `upstream/nature-writing/references/examples/introduction/pipeline-version-3-new-module-on-existing-pipeline.md`
...
1. `upstream/nature-writing/references/examples/introduction/pipeline-version-4-observation-driven.md`
...
1. `upstream/nature-writing/references/examples/introduction/pipeline-not-recommended-abstract-only.md`

## Example Bank

1. `upstream/nature-writing/references/examples/introduction-examples.md`
2. `upstream/nature-writing/references/examples/introduction/version-1-task-then-application.md`
3. `upstream/nature-writing/references/examples/introduction/version-2-application-first.md`
4. `upstream/nature-writing/references/examples/introduction/version-3-general-to-specific-setting.md`
5. `upstream/nature-writing/references/examples/introduction/version-4-open-with-challenge.md`
6. `upstream/nature-writing/references/examples/introduction/technical-challenge-version-1-existing-task.md`
7. `upstream/nature-writing/references/examples/introduction/technical-challenge-version-2-existing-task-insight-backed-by-traditional.md`
8. `upstream/nature-writing/references/examples/introduction/technical-challenge-version-3-novel-task.md`
9. `upstream/nature-writing/references/examples/introduction/pipeline-version-1-one-contribution-multi-advantages.md`
10. `upstream/nature-writing/references/examples/introduction/pipeline-version-2-two-contributions.md`
11. `upstream/nature-writing/references/examples/introduction/pipeline-version-3-new-module-on-existing-pipeline.md`
12. `upstream/nature-writing/references/examples/introduction/pipeline-version-4-observation-driven.md`
13. `upstream/nature-writing/references/examples/introduction/pipeline-not-recommended-abstract-only.md`

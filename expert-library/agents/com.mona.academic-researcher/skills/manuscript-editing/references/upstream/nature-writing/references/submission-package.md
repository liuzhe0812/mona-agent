...
| Template | Purpose |
|---|---|
| `upstream/nature-writing/templates/submission/initial-cover-letter.tex` | Initial editor-facing cover letter |
| `upstream/nature-writing/templates/submission/title-page.tex` | Identified title page and declarations |
| `upstream/nature-writing/templates/submission/highlights-and-summary.tex` | Highlights and editorial/significance summary |
| `upstream/nature-writing/templates/submission/declarations-and-reviewers.tex` | Submission declarations and reviewer suggestions |

...
`upstream/nature-shared/core/nature-results-discussion.md` for the three
archetypes and the same-level-repetition test.

## Drafting rules

- Load `upstream/nature-shared/core/main-text-discipline.md` before deciding
...
For ML/conference-style experiment sections — baselines, ablations, metrics, tables, figures — open `upstream/nature-writing/references/experiments.md`.

...
1. Use this file together with `upstream/nature-writing/references/abstract.md` when the user is drafting an abstract for a broad-audience Nature-family venue.
2. Use `upstream/nature-writing/static/fragments/journal/nature.md` for journal-level constraints such as audience and claim calibration.
3. Use `upstream/nature-writing/static/fragments/section/abstract.md` for the compact default abstract movement.

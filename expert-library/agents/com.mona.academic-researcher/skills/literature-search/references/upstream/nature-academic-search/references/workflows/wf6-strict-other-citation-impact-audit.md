...
**Uses:**
- [Search Strategy](upstream/nature-academic-search/references/search-strategy.md) — construct title/DOI/cited-by queries.
- [Dedup Engine](upstream/nature-academic-search/references/dedup-engine.md) — deduplicate citing records across sources.
- [Source Tiers](upstream/nature-academic-search/references/source-tiers.md) — report source coverage and confidence limits.
...
2. **Retrieve citing papers with source coverage stated.**
   ...
   - Use multiple sources when possible, then deduplicate with
     [Dedup Engine](upstream/nature-academic-search/references/dedup-engine.md).

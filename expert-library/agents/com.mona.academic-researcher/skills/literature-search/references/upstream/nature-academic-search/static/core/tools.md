...
| Module | Purpose |
|--------|---------|
| [Dedup Engine](upstream/nature-academic-search/references/dedup-engine.md) | Unified deduplication (WFs 1, 2, 5a) |
| [Citation Parser](upstream/nature-academic-search/references/citation-parser.md) | Extract citations from documents (WF 2) |
| [Search Strategy](upstream/nature-academic-search/references/search-strategy.md) | Query construction, source selection, ranking |
| [RIS/BibTeX Format](upstream/nature-academic-search/references/ris-bibtex-format.md) | Format specifications and field mappings |
| `skill_script_run(skill="literature-search", script="format-converter.py", ...)` | Multi-source .nbib/.ris/.bib downloader; pass an absolute active-workspace output path |

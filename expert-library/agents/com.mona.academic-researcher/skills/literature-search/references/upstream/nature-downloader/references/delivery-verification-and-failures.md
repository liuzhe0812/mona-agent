...
- Do not ask for or accept institutional credentials in chat. On Windows, publisher API keys must use Mona's secure credential settings or provider environment variables; plaintext skill files are disabled.

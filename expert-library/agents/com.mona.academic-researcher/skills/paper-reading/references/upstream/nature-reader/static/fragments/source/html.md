...
- Figures and tables are usually separate image/HTML elements — capture each figure image and its caption, and place per `upstream/nature-reader/references/figure-extraction.md`. Reconstruct HTML tables faithfully rather than screenshotting them when the markup is clean.

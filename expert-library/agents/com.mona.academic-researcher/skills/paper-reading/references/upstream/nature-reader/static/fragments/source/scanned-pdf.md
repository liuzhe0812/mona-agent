...
- Figures and tables are page regions: crop them per `upstream/nature-reader/references/figure-extraction.md`. For low-quality scans, a tight correct crop still beats a wide noisy one.

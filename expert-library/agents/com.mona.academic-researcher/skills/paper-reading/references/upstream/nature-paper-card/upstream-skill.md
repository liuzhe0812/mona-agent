...
- a static core under `upstream/nature-paper-card/static/core/` for principles, workflow, and the fixed output contract;
- one paper-type fragment under `upstream/nature-paper-card/static/fragments/paper_type/`;
...
Read [manifest.yaml](upstream/nature-paper-card/manifest.yaml), then read every file under `always_load`. Do not generate the card from this router alone.
...
Read [references/evidence-and-provenance.md](upstream/nature-paper-card/references/evidence-and-provenance.md) before making analytical or externally verified claims. Read [references/card-schema.md](upstream/nature-paper-card/references/card-schema.md) when drafting the final Markdown. Read [references/research-idea-gates.md](upstream/nature-paper-card/references/research-idea-gates.md) before writing Section 16.

...
- `upstream/nature-figure/references/api.md` — Python PALETTE, helper function signatures, validation rules.
- `upstream/nature-figure/references/template-catalog.md` — validated CSV-driven volcano, ROC, dot-plot, marginal, and paired templates backed by `scripts/plot_templates.py`.
- `upstream/nature-figure/references/common-patterns.md` — hero panels, legend-only axes, dark image plates, asymmetric layouts.
- `upstream/nature-figure/references/chart-types.md` — radar, 3D sphere, fill_between, scatter patterns.
- `upstream/nature-figure/references/tutorials.md` — end-to-end walkthroughs for bars, trends, heatmaps.
- `upstream/nature-figure/references/demos.md` — third-party figures4papers demo map, copyright boundary, and original Python reimplementation guidance.

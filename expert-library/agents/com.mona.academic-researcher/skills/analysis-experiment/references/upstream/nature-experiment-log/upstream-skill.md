...
| 文件 | 模板 | 用途 |
|------|------|------|
| `实验日志/实验索引.md` | `upstream/nature-experiment-log/templates/experiment-index.md` | Dataview 查询仪表盘 |
| `实验日志/异常记录.md` | `upstream/nature-experiment-log/templates/anomaly-log.md` | 异常记录 |
| `实验日志/公共/设备与试剂追踪.md` | `upstream/nature-experiment-log/templates/equipment-tracking.md` | 设备与试剂追踪 |

将模板文件复制到你的 Obsidian vault 对应位置即可使用。

## 参考示例

`upstream/nature-experiment-log/references/` 目录包含三个完整的实验日志示例，覆盖常见实验类型：

| 文件 | 实验类型 |
|------|---------|
| `upstream/nature-experiment-log/references/example-log.md` | 材料腐蚀浸泡实验 |
| `upstream/nature-experiment-log/references/example-electrochemical.md` | 电化学表征（CV 窗口测试） |
| `upstream/nature-experiment-log/references/example-thermal-stability.md` | 热稳定性实验 |
...
| 文件 | 用途 |
|------|------|
| `upstream/nature-experiment-log/references/example-log.md` | 完整实验日志示例 |

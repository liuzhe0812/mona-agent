...
echo "mona line count"
echo "=================="
echo ""

echo "Core runtime"
echo "------------"
core_agent=$(count_top_level_py_lines "mona/agent")
core_bus=$(count_top_level_py_lines "mona/bus")
core_config=$(count_top_level_py_lines "mona/config")
core_cron=$(count_top_level_py_lines "mona/cron")
core_heartbeat=$(count_top_level_py_lines "mona/heartbeat")
core_session=$(count_top_level_py_lines "mona/session")
...
echo "----------------"
extra_tools=$(count_recursive_py_lines "mona/agent/tools")
extra_skills=$(count_skill_lines "mona/skills")
extra_api=$(count_recursive_py_lines "mona/api")
extra_cli=$(count_recursive_py_lines "mona/cli")
extra_channels=$(count_recursive_py_lines "mona/channels")
extra_utils=$(count_recursive_py_lines "mona/utils")
...
echo "Notes"
echo "-----"
echo "  - agent/ only counts top-level Python files under mona/agent"
echo "  - tools/ is counted separately from mona/agent/tools"
echo "  - skills/ counts .md, .py, and .sh files"
echo "  - not included here: command/, providers/, security/, templates/, mona.py, root files"

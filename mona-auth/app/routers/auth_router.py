...
from app.models import AppConfig, CreditWallet, PasswordResetCode, UsedDeviceTrial, User
...
def login(request: Request, body: LoginRequest, db: Session = Depends(get_db)):
    ...
    user = (
        db.query(User).filter((User.email == body.account) | (User.account == body.account)).first()
    )

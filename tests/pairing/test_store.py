...
from mona.pairing import __all__ as pairing_all
from mona.pairing import store


def test_all_exports_are_importable():
    """Every name in __all__ must actually be importable from mona.pairing."""
    import mona.pairing as pkg

...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("mona.agent.tools.filesystem.ListDirTool.execute", fake_execute)

        from mona.agent.subagent import SubagentStatus
    ...
    async def test_cancel_by_session_cancels_running_subagent_tool(self, monkeypatch, tmp_path):
        from mona.agent.subagent import SubagentManager, SubagentStatus
        from mona.bus.queue import MessageBus
        from mona.providers.base import LLMResponse, ToolCallRequest

...
async def test_drain_injections_passes_limit_to_callback_when_supported():
    ...
    from mona.agent.runner import AgentRunSpec, AgentRunner, _MAX_INJECTIONS_PER_TURN
    from mona.bus.events import InboundMessage
...
async def test_injection_cycles_capped_at_max():
    ...
    from mona.agent.runner import AgentRunSpec, AgentRunner, _MAX_INJECTION_CYCLES
    from mona.bus.events import InboundMessage
...
async def test_pending_queue_preserves_overflow_for_next_injection_cycle(tmp_path):
    ...
    from mona.bus.events import InboundMessage
    from mona.bus.queue import MessageBus
    from mona.agent.runner import _MAX_INJECTIONS_PER_TURN
...
async def test_drain_injections_on_empty_final_response():
    ...
    from mona.agent.runner import AgentRunSpec, AgentRunner, _MAX_EMPTY_RETRIES
    from mona.bus.events import InboundMessage

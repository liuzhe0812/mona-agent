...
from mona.agent.tools.web import WebFetchTool, _validate_url
...
def _patch_env():
    return patch("mona.security.network.socket.getaddrinfo", _fake_resolve_public), \
           patch("mona.agent.tools.web.httpx.AsyncClient", FakeClient)

...
from mona.security.network import validate_resolved_url, validate_url_target
...
class monaDingTalkHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the mona channel.
    """
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = monaDingTalkHandler(self)
    ...
    async def _on_message(
        ...
        """Handle incoming message (called by monaDingTalkHandler).

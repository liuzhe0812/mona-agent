...
from mona.config.paths import get_media_dir, get_runtime_subdir
from mona.config.schema import Base
from mona.utils.helpers import split_message
...
class WeixinConfig(Base):
    ...
    state_dir: str = ""  # Default: ~/.mona/weixin/
...
class WeixinChannel(BaseChannel):
    ...
    async def _send_text(
        ...
        client_id = f"mona-{uuid.uuid4().hex[:12]}"

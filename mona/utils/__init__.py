...
from mona.utils.path import abbreviate_path
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "mona.webui.thread_disk",
    "webui_transcript": "mona.webui.transcript",
    "webui_turn_helpers": "mona.session.webui_turns",
}

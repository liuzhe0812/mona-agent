...
_FREE_TIER_CAPABILITY_NOTE = (
    ...
    "notes (notes_read)\n"
    "- Creating, editing, or saving images to notes (notes_create, notes_edit, "
    "notes_save_image)\n"
    ...
    "- Do NOT create, edit, or save images to notes.\n"
    "- If the user asks you to operate on notes, materials, or emails, explain "
    "that an active subscription or trial is required and they can subscribe "

...
- Gallery: https://github.com/freestylefly/awesome-gpt-image-2/blob/main/docs/gallery-part-2.md#case-331

````text
生成一张手绘水彩风格的「西安」城市地图，包含当地特色美食、地标建筑及城市特色
````

## Case 11 — 一张手绘风格的城市美食地图，以台州为主题

- Category: Architecture & Spaces
- Styles: Illustration
- Scenes: Travel
- Source: 小红书号510244722
- Gallery: https://github.com/freestylefly/awesome-gpt-image-2/blob/main/docs/gallery-part-1.md#case-11

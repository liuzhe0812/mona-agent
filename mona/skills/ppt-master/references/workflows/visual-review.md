...
- **Iteration budget**: default 1 iteration. Bumping to 2 doubles render cost and roughly triples token cost on the affected pages. Only worth it for high-stakes / final-cut decks.

...
> AI image generation is now handled by Mona's `generate_image` tool — see `references/image-generator.md` for details.
...
- Prefer the unified entry points `project_manager.py`, `finalize_svg.py`

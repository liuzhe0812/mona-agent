...
class ProjectManager:
    ...
    def __init__(self, base_dir: str = "ppt_projects") -> None:
    ...
    def init_project(
        ...
        readme_path.write_text(
            (
                ...
                f"- Created: {date_str}\n\n"
                "## Directories\n\n"
                "- `output/`: PPTX output (output.pptx)\n"
                "- `images/`: presentation assets\n"
                "- `templates/`: project templates\n"
                "- `sources/`: source materials and normalized markdown\n"
                "- `exports/`: exported pptx copies (timestamped)\n"
            ),
            encoding="utf-8",
        )
    ...
    def import_sources(
        ...
        for item in source_items:
            ...
            if copy:
                ...
                effective_move = True
                print(
                    f"note: {source_path} is inside the mona-ppt repo; moved "

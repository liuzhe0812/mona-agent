...
| Pattern | Example |
|---|---|
| "继续生成 ppt_projects/<project_name>" | "继续生成 ppt_projects/ppt169_joe_hisaishi" |
| "resume execution ppt_projects/<project_name>" | "resume execution ppt_projects/ppt169_joe_hisaishi" |
| Project path + any "继续 / 恢复 / 继续做 / 接着做" semantic | "把 ppt_projects/ppt169_joe_hisaishi 继续做完" |

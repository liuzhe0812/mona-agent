...
interface ReviewTabProps extends TabProps {
  /** Embedded in Mona's Office host; GenOffice-owned AI actions are not shown. */
  embedded?: boolean
...
interface ViewTabProps {
  /** Embedded in Mona's Office host; internal AI and window management are host-owned. */
  embedded?: boolean
  hasDoc: boolean

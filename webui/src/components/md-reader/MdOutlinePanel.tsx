  ...
  return (
    ...
    >
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-2 scrollbar-thin">
        {outline.length === 0 ? (
          <div className="px-1 py-2 text-caption text-muted-foreground/70">
            暂无标题
          </div>
        ) : (
          <div className="flex flex-col gap-0.5">
            {outline.map((h, idx) => (
              <Button
                ...
                className="h-auto w-full justify-start truncate rounded-xs px-1.5 py-1 text-left font-normal text-caption text-muted-foreground hover:bg-accent hover:text-foreground"

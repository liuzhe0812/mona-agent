...
import { DEFAULT_NOTE_TITLE, deriveNoteTitle } from "@/lib/note-title";
...
export const NoteEditor = forwardRef<NoteEditorHandle, NoteEditorProps>(function NoteEditor({
  ...
  const handleContentChange = (next: {
    ...
    if (!hadNewlineRef.current && hasNewlineNow && note.title === DEFAULT_NOTE_TITLE) {
      const title = deriveNoteTitle(plainText, "");
      if (title) {
        onTitleChange(title);
      }
    }
